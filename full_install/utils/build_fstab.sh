...
echo "$HOME_FSTAB_ENTRY" | tee -a /etc/fstab
...
echo "$VAR_FSTAB_ENTRY" | tee -a /etc/fstab
...
echo "$TMP_FSTAB_ENTRY" | tee -a /etc/fstab
...
echo "$USR_FSTAB_ENTRY" | tee -a /etc/fstab
...
echo "$OPT_FSTAB_ENTRY" | tee -a /etc/fstab
...
echo "$VARLOG_FSTAB_ENTRY" | tee -a /etc/fstab
